...
class MainApplication(Frame):
    def __init__(self, parent, controller, *args, **kwargs):
        ...
        menu_cloud = Menu(menubar)
        menu_cloud.add_command(label='Adressen von Cloud laden', command=self.cloud_download_addresses)
        menu_cloud.add_command(label='Kunden von Cloud laden', command=self.cloud_download_customers)
        menu_cloud.add_separator()
        menu_cloud.add_command(label='Adressen in Cloud hochladen', command=self.cloud_upload_addresses)
        menu_cloud.add_command(label='Kunden in Cloud hochladen', command=self.cloud_upload_customers)
        ...
        menubar.add_cascade(menu=menu_cloud, label='Cloud')
